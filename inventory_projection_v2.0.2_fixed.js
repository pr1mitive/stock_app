  ...
  async function upsertSummaryRecords(itemCode, warehouse, location, summaryData) {
    ...
    for (const data of summaryData) {
      ...
      const recordData = {
        ...
        [CONFIG.FIELDS.PROJECTION.BEGINNING_QTY]: { value: data.opening_qty },
        [CONFIG.FIELDS.PROJECTION.ACTUAL_RECEIVED_QTY]: { value: data.received_qty },
        [CONFIG.FIELDS.PROJECTION.ACTUAL_ISSUED_QTY]: { value: data.issued_qty },
